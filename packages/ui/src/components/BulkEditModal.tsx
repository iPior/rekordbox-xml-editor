...
import type { BulkEditPatch } from "@rekordbox/types";
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={(event) => event.stopPropagation()}>
        ...
        <p>Only set fields that should be changed for all selected tracks.</p>
        ...
        <label>
          Key
          <input value={patch.key ?? ""} onChange={(event) => setPatch({ ...patch, key: event.target.value })} />
        </label>
